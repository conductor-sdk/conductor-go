...
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/decide/{workflowId}"
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{workflowId}/remove"
// 	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", fmt.Sprintf("%v", workflowId), -1)
...
// func (a *WorkflowResourceApiService) GetExecutionStatus(ctx context.Context, workflowId string, localVarOptionals *WorkflowResourceApiGetExecutionStatusOpts) (Workflow, *http.Response, error) {
// 	var (
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{workflowId}"
// 	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", fmt.Sprintf("%v", workflowId), -1)
...
// */
// func (a *WorkflowResourceApiService) GetExternalStorageLocation(ctx context.Context, path string, operation string, payloadType string) (ExternalStorageLocation, *http.Response, error) {
// 	var (
// 		localVarHttpMethod  = strings.ToUpper("Get")
// 		localVarPostBody    interface{}
// 		localVarFileName    string
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/externalstoragelocation"
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/running/{name}"
...
// func (a *WorkflowResourceApiService) GetWorkflows(ctx context.Context, body []string, name string, localVarOptionals *WorkflowResourceApiGetWorkflowsOpts) (map[string][]Workflow, *http.Response, error) {
// 	var (
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{name}/correlated"
// 	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", fmt.Sprintf("%v", name), -1)
...
// func (a *WorkflowResourceApiService) GetWorkflows1(ctx context.Context, name string, correlationId string, localVarOptionals *WorkflowResourceApiGetWorkflows1Opts) ([]Workflow, *http.Response, error) {
// 	var (
// 		localVarHttpMethod  = strings.ToUpper("Get")
// 		localVarPostBody    interface{}
// 		localVarFileName    string
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{name}/correlated/{correlationId}"
// 	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", fmt.Sprintf("%v", name), -1)
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{workflowId}/pause"
// 	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", fmt.Sprintf("%v", workflowId), -1)
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{workflowId}/rerun"
// 	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", fmt.Sprintf("%v", workflowId), -1)
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{workflowId}/resetcallbacks"
// 	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", fmt.Sprintf("%v", workflowId), -1)
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{workflowId}/restart"
// 	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", fmt.Sprintf("%v", workflowId), -1)
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{workflowId}/resume"
// 	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", fmt.Sprintf("%v", workflowId), -1)
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{workflowId}/retry"
// 	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", fmt.Sprintf("%v", workflowId), -1)
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/search"
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/search-v2"
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/search-by-tasks"
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/search-by-tasks-v2"
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{workflowId}/skiptask/{taskReferenceName}"
// 	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", fmt.Sprintf("%v", workflowId), -1)
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow/{name}"
// 	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", fmt.Sprintf("%v", name), -1)
...
// 	// create path and map variables
// 	localVarPath := a.client.cfg.BasePath + "/api/workflow"
