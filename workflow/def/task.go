...
type TaskInterface interface {
	toWorkflowTask() []model2.WorkflowTask
	OutputRef(path string) string
	ToTaskDef() *model2.TaskDef
}
...
func (task *Task) toWorkflowTask() []model2.WorkflowTask {
	return []model2.WorkflowTask{
		{
			Name:              task.name,
...
func (task *Task) ToTaskDef() *model2.TaskDef {
	return &model2.TaskDef{
		Name:        task.name,
		Description: task.description,
	}
}
