...
func NewStartWorkflowTask(taskRefName string, workflowName string, version *int32, startWorkflowRequest *model2.StartWorkflowRequest) *StartWorkflowTask {
...
func (task *StartWorkflowTask) toWorkflowTask() []model2.WorkflowTask {
