...
func (e *WorkflowExecutor) GetWorkflow(workflowId string, includeTasks bool) (*model2.Workflow, error) {
...
func (e *WorkflowExecutor) GetWorkflowStatus(workflowId string, includeOutput bool, includeVariables bool) (*model2.WorkflowState, error) {
...
func (e *WorkflowExecutor) GetByCorrelationIds(workflowName string, includeClosed bool, includeTasks bool, correlationIds ...string) (map[string][]model2.Workflow, error) {
...
func (e *WorkflowExecutor) Search(start int32, size int32, query string, freeText string) ([]model2.WorkflowSummary, error) {
...
func (e *WorkflowExecutor) ReRun(workflowId string, reRunRequest model2.RerunWorkflowRequest) (id string, error error) {
...
func (e *WorkflowExecutor) SkipTasksFromWorkflow(workflowId string, taskReferenceName string, skipTaskRequest model2.SkipTaskRequest) error {
