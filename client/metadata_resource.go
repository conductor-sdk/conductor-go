...
*/
func (a *MetadataResourceApiService) RegisterWorkflowDef(ctx context.Context, overwrite bool, body model2.WorkflowDef) (*http.Response, error) {
	var (
...
func (a *MetadataResourceApiService) Get(ctx context.Context, name string, localVarOptionals *MetadataResourceApiGetOpts) (model2.WorkflowDef, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue model2.WorkflowDef
	)
...
@return []http_model.WorkflowDef
*/
func (a *MetadataResourceApiService) GetAll(ctx context.Context) ([]model2.WorkflowDef, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *MetadataResourceApiService) GetTaskDef(ctx context.Context, tasktype string) (model2.TaskDef, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue model2.TaskDef
	)
...
@return []http_model.TaskDef
*/
func (a *MetadataResourceApiService) GetTaskDefs(ctx context.Context) ([]model2.TaskDef, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *MetadataResourceApiService) UpdateTaskDef(ctx context.Context, body model2.TaskDef) (*http.Response, error) {
	var (
...
*/
func (a *MetadataResourceApiService) RegisterTaskDef(ctx context.Context, body []model2.TaskDef) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *MetadataResourceApiService) Update(ctx context.Context, body []model2.WorkflowDef) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
