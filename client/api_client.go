...
type APIClient struct {
	authenticationSettings *settings2.AuthenticationSettings
	authenticationToken    *string
	httpSettings           *settings2.HttpSettings
...
func NewAPIClient(
	...
	if httpSettings == nil {
		httpSettings = settings2.NewHttpDefaultSettings()
	}
...
func (c *APIClient) getToken() (model2.Token, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue model2.Token
	)
	localVarPath := "/token"
