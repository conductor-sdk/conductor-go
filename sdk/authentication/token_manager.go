...
func (t *TokenManager) refreshToken(httpSettings *settings.HttpSettings, httpClient *http.Client) (string, error) {
	...
	token, response, err := t.getToken(httpSettings, httpClient)
	if err != nil {
		log.Warning(
...
func (t *TokenManager) getToken(httpSettings *settings.HttpSettings, httpClient *http.Client) (model.Token, *http.Response, error) {
	var (
	...
	localVarPostBody = t.credentials.GetBody()
	r, err := t.prepareRequest(context.Background(), httpSettings, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
...
func (t *TokenManager) prepareRequest(
	ctx context.Context,
