...
func (a *GroupResourceApiService) AddUserToGroup(ctx context.Context, groupId string, userId string) (interface{}, *http.Response, error) {
	...
	localVarPath := "/groups/{groupId}/users/{userId}"
...
func (a *GroupResourceApiService) AddUsersToGroup(ctx context.Context, body []string, groupId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := "/groups/{groupId}/users"
	localVarPath = strings.Replace(localVarPath, "{"+"groupId"+"}", fmt.Sprintf("%v", groupId), -1)
...
@return interface{}
*/
func (a *GroupResourceApiService) GetGrantedPermissions1(ctx context.Context, groupId string) (interface{}, *http.Response, error) {
	var (
...
@return []model.Group
*/
func (a *GroupResourceApiService) ListGroups(ctx context.Context) ([]model.Group, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return interface{}
*/
func (a *GroupResourceApiService) UpsertGroup(ctx context.Context, body model.UpsertGroupRequest, id string) (interface{}, *http.Response, error) {
	var (
