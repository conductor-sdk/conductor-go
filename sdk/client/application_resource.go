...
func (a *ApplicationResourceApiService) AddRoleToApplicationUser(ctx context.Context, applicationId string, role string) (interface{}, *http.Response, error) {
	...
	localVarPath := "/applications/{applicationId}/roles/{role}"
...
func (a *ApplicationResourceApiService) CreateAccessKey(ctx context.Context, id string) (interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := "/applications/{id}/accessKeys"
...
@return interface{}
*/
func (a *ApplicationResourceApiService) CreateApplication(ctx context.Context, body model.CreateOrUpdateApplicationRequest) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ApplicationResourceApiService) DeleteAccessKey(ctx context.Context, applicationId string, keyId string) (interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := "/applications/{applicationId}/accessKeys/{keyId}"
	localVarPath = strings.Replace(localVarPath, "{"+"applicationId"+"}", fmt.Sprintf("%v", applicationId), -1)
...
ApplicationResourceApiService Delete a tag for application
  ...
  - @param id
*/
func (a *ApplicationResourceApiService) DeleteTagForApplication(ctx context.Context, body []model.TagObject, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := "/applications/{id}/tags"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
*/
func (a *ApplicationResourceApiService) GetTagsForApplication(ctx context.Context, id string) ([]model.TagObject, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return []model.ExtendedConductorApplication
*/
func (a *ApplicationResourceApiService) ListApplications(ctx context.Context) ([]model.ExtendedConductorApplication, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []model.ExtendedConductorApplication
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []model.ExtendedConductorApplication
			err = a.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
ApplicationResourceApiService Put a tag to application
  ...
  - @param id
*/
func (a *ApplicationResourceApiService) PutTagForApplication(ctx context.Context, body []model.TagObject, id string) (*http.Response, error) {
	var (
...
func (a *ApplicationResourceApiService) ToggleAccessKeyStatus(ctx context.Context, applicationId string, keyId string) (interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := "/applications/{applicationId}/accessKeys/{keyId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"applicationId"+"}", fmt.Sprintf("%v", applicationId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"keyId"+"}", fmt.Sprintf("%v", keyId), -1)
...
@return interface{}
*/
func (a *ApplicationResourceApiService) UpdateApplication(ctx context.Context, body model.CreateOrUpdateApplicationRequest, id string) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
