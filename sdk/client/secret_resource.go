...
/*
SecretResourceApiService Delete a tag by secret
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param key
*/
func (a *SecretResourceApiService) DeleteTagForSecret(ctx context.Context, body []model.TagObject, key string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *SecretResourceApiService) GetSecret(ctx context.Context, key string) (interface{}, *http.Response, error) {
	var (
...
*/
func (a *SecretResourceApiService) GetTags(ctx context.Context, key string) ([]model.TagObject, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return interface{}
*/
func (a *SecretResourceApiService) ListAllSecretNames(ctx context.Context) (interface{}, *http.Response, error) {
	var (
...
@return []interface{}
*/
func (a *SecretResourceApiService) ListSecretsThatUserCanGrantAccessTo(ctx context.Context) ([]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return []model.ExtendedSecret
*/
func (a *SecretResourceApiService) ListSecretsWithTagsThatUserCanGrantAccessTo(ctx context.Context) ([]model.ExtendedSecret, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []model.ExtendedSecret
	)

	// create path and map variables
	localVarPath := "/secrets-v2"
...
/*
SecretResourceApiService Put a tag by secret
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param key
*/
func (a *SecretResourceApiService) PutTagForSecret(ctx context.Context, body []model.TagObject, key string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *SecretResourceApiService) SecretExists(ctx context.Context, key string) (interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := "/secrets/{key}/exists"
	localVarPath = strings.Replace(localVarPath, "{"+"key"+"}", fmt.Sprintf("%v", key), -1)
