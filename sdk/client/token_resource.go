...
type TokenResourceApiService struct {
	*APIClient
}

/*
TokenResourceApiService Generate JWT with the given access key
...
/*
TokenResourceApiService Get the user info from the token
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TokenResourceApiGetUserInfoOpts - Optional Parameters:
     * @param "Claims" (optional.Bool) -
@return interface{}
*/

type TokenResourceApiGetUserInfoOpts struct {
	Claims optional.Bool
}

func (a *TokenResourceApiService) GetUserInfo(ctx context.Context, localVarOptionals *TokenResourceApiGetUserInfoOpts) (interface{}, *http.Response, error) {
	var (
