...
func (a *WorkflowResourceApiService) JumpToTask(ctx context.Context, body map[string]interface{}, workflowId string, opts *WorkflowResourceApiJumpToTaskOpts) (*http.Response, error) {
	// create path and map variables
	path := fmt.Sprintf("/api/workflow/%s/jump/%s", workflowId, opts.TaskReferenceName.Value())
