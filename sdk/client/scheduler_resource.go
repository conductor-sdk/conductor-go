...
SchedulerResourceApiService Delete a tag for schedule
  ...
  - @param name
*/
func (a *SchedulerResourceApiService) DeleteTagForSchedule(ctx context.Context, body []model.TagObject, name string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return []model.ExtendedWorkflowSchedule
*/
...
func (a *SchedulerResourceApiService) GetAllSchedules(ctx context.Context, localVarOptionals *SchedulerResourceApiGetAllSchedulesOpts) ([]model.ExtendedWorkflowSchedule, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []model.ExtendedWorkflowSchedule
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []model.ExtendedWorkflowSchedule
			err = a.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
*/
func (a *SchedulerResourceApiService) GetTagsForSchedule(ctx context.Context, name string) ([]model.TagObject, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
SchedulerResourceApiService Put a tag to schedule
  ...
  - @param name
*/
func (a *SchedulerResourceApiService) PutTagForSchedule(ctx context.Context, body []model.TagObject, name string) (*http.Response, error) {
	var (
...
func (a *SchedulerResourceApiService) RequeueAllExecutionRecords(ctx context.Context) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := "/scheduler/admin/requeue"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SchedulerResourceApiSearchV22Opts - Optional Parameters:
...
@return model.SearchResultWorkflowScheduleExecutionModel
*/

type SchedulerResourceApiSearchV22Opts struct {
...
func (a *SchedulerResourceApiService) SearchV22(ctx context.Context, localVarOptionals *SchedulerResourceApiSearchV22Opts) (model.SearchResultWorkflowScheduleExecutionModel, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
SchedulerResourceApiService Test timeout - do not use in production
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
*/
func (a *SchedulerResourceApiService) TestTimeout(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := "/scheduler/test/timeout"
